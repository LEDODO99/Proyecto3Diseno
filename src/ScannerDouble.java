   ...
   public String ValidarAutomata(String cadena){
    ...
    private void generateAutoma(){
       automata = new Grafo();
		...
		automata.addNode(0, "	");
		automata.getNodo(automata.getCantidadNodos()-1).setIsFinal(true);
		automata.getNodo(automata.getCantidadNodos()-1).setToken("white");
		automata.getNodo(automata.getCantidadNodos()-1).setTokenNumber(2);
		automata.getNodo(automata.getCantidadNodos()-1).setTokenType(1);
		automata.addTransicion(0, 2, "\n");
		automata.addTransicion(0, 2, "\n\t ");
		automata.addNode(0, ".");
		automata.getNodo(automata.getCantidadNodos()-1).setIsFinal(true);
		...
		automata.getNodo(automata.getCantidadNodos()-1).setTokenNumber(2);
		automata.getNodo(automata.getCantidadNodos()-1).setTokenType(1);
		automata.addTransicion(2, 13, "\n");
		automata.addTransicion(2, 13, "\n\t ");
		automata.addTransicion(11, 11, "0123456789");
		automata.addTransicion(11, 12, ".");
		automata.addNode(12, "0123456789");
		automata.getNodo(automata.getCantidadNodos()-1).setIsFinal(true);
		automata.getNodo(automata.getCantidadNodos()-1).setToken("decnumber");
		automata.getNodo(automata.getCantidadNodos()-1).setTokenNumber(1);
		automata.getNodo(automata.getCantidadNodos()-1).setTokenType(1);
		automata.addTransicion(13, 13, "	");
		automata.addTransicion(13, 13, "\n");
		automata.addTransicion(13, 13, "\n\t ");
		automata.addNode(14, "0123456789");
		automata.getNodo(automata.getCantidadNodos()-1).setIsFinal(true);
		automata.getNodo(automata.getCantidadNodos()-1).setToken("decnumber");
		automata.getNodo(automata.getCantidadNodos()-1).setTokenNumber(1);
		automata.getNodo(automata.getCantidadNodos()-1).setTokenType(1);
		automata.addTransicion(15, 15, "0123456789");
    }}
