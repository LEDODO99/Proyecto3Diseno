...
public class ParserDouble {
    ...
    private void Expr() {
        if (currentToken.getTokenType() == 6 || currentToken.getTokenType() == 0 || currentToken.getTokenType() == 1
                || currentToken.getTokenType() == 9 || currentToken.getTokenType() == 2
                || currentToken.getTokenType() == 4) {
            while (currentToken.getTokenType() == 6 || currentToken.getTokenType() == 0
                    || currentToken.getTokenType() == 1 || currentToken.getTokenType() == 9
                    || currentToken.getTokenType() == 2) {
                if (currentToken.getTokenType() == 6 || currentToken.getTokenType() == 0
                        || currentToken.getTokenType() == 1 || currentToken.getTokenType() == 9) {
                    Stat();
                    Expect(3);
    ...
    private void Expression(DoubleRef result) {
        if (currentToken.getTokenType() == 6 || currentToken.getTokenType() == 0 || currentToken.getTokenType() == 1
                || currentToken.getTokenType() == 9) {
            DoubleRef result1 = new DoubleRef();
            DoubleRef result2 = new DoubleRef();
            Term(result1);
