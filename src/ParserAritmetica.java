...
public class ParserAritmetica {
    ...
    private void Expr() {
        if (currentToken.getTokenType() == 5 || currentToken.getTokenType() == 1 || currentToken.getTokenType() == 8
                || currentToken.getTokenType() == 3) {
            while (currentToken.getTokenType() == 5 || currentToken.getTokenType() == 1
                    || currentToken.getTokenType() == 8) {
                if (currentToken.getTokenType() == 5 || currentToken.getTokenType() == 1
                        || currentToken.getTokenType() == 8) {
                    Stat();
                    Expect(2);
                }
    ...
    private void Expression(IntegerRef result) {
        if (currentToken.getTokenType() == 5 || currentToken.getTokenType() == 1 || currentToken.getTokenType() == 8) {
            IntegerRef result1 = new IntegerRef();
            IntegerRef result2 = new IntegerRef();
            Term(result1);
